...
class MainActivityTest {
    ...
    fun click_1_2_3_shows_123() {
        // given
        // when: click 1 2 3
        performClick(R.id.button1, R.id.button2, R.id.button3)
    ...
    fun click_1_3_plus_2_2_shows_13_plus_22() {
        // given
        // when: click 1 3 + 2 2
        performClick(R.id.button1, R.id.button3, R.id.buttonPlus, R.id.button2, R.id.button2)
    ...
    fun click_9_multiply_divide_3_shows_9_divide_3() {
        // given
        // when: click 9 * / 3
        performClick(R.id.button9, R.id.buttonMultiply, R.id.buttonDivide, R.id.button3)
    ...
    fun click_2_multiply_3_3_equals_66() {
        // given: click 2 * 3 3
        performClick(R.id.button2, R.id.buttonMultiply, R.id.button3, R.id.button3)
    ...
    private fun performClick(vararg ids: Int) {
        ids.forEach { id ->
